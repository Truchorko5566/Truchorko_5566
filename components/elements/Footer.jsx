   ...
   <div className="flex w-full flex-col items-center gap-2 lg:flex-row lg:justify-between lg:gap-0">
    ...
    <NextLink href="/">
     <p className="flex cursor-pointer items-center text-2xl font-semibold">
      Truchorko_<span className="bg-gradient-to-r from-[#6310ff] to-[#1491ff] box-decoration-clone bg-clip-text text-fill-transparent dark:from-[#a2facf] dark:to-[#64acff]">.</span> <span className="mx-1 mr-2 rounded-lg bg-black/[7%] px-2 py-1 text-xs dark:bg-white/10">v{appVersion}</span>
     </p>
    </NextLink>
    {/* --- */}
    <div className="items-center space-x-6 lg:flex">
     <div className="mt-2 text-left text-gray-700 dark:text-gray-400 lg:mt-0 lg:text-right">
      <p className="font-semibold">&copy; 2019 - {new Date().getFullYear()} Truchorko_, All rights reserved.</p>
      <p className="italic">
